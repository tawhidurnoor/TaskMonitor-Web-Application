...
<head>
    <title>Login - TaskMonitor | Project management solution for your organization</title>
    <meta charset="utf-8" />
  ...
  <meta name="viewport" content="width=device-width, initial-scale=1" /> --}}
    ...
    <meta property="og:title" content="Login - Timetracker | Project management solution for your organization" />
                ...
                <div class="w-lg-500px bg-body rounded shadow-sm p-10 p-lg-15 mx-auto">
                    ...
                    <form class="form w-100" novalidate="novalidate" id="kt_sign_in_form" method="POST"
                        ...
                        <div class="text-center mb-10">
                            <!--begin::Title-->
                            <h1 class="text-dark mb-3">Sign In to TaskMonitor</h1>
                            <!--end::Title-->
                            <!--begin::Link-->
                        ...
                        <div class="fv-row mb-10">
                            ...
                            <div class="d-flex flex-stack mb-2">
                                ...
                                <!--end::Label-->
                                <!--begin::Link-->
                                <a href="{{ route('password.update') }}" class="link-primary fs-6 fw-bolder">Forgot
                                    Password ?</a>
                                <!--end::Link-->
                            </div>
                            <!--end::Wrapper-->
