...
<body id="kt_body" class="bg-body">
        ...
        <div class="d-flex flex-column flex-column-fluid bgi-position-y-bottom position-x-center bgi-no-repeat bgi-size-contain bgi-attachment-fixed"
            ...
            <div class="d-flex flex-center flex-column-auto p-10">
                ...
                <div class="d-flex align-items-center fw-bold fs-6">
                    <a href="http://www.codecloudtech.com/" class="text-muted text-hover-primary px-2">About</a>
                    <a href="mailto:support@codecloudtech.com" class="text-muted text-hover-primary px-2">Contact</a>
                    <a href="http://www.codecloudtech.com/" class="text-muted text-hover-primary px-2">Contact Us</a>
                </div>
                <!--end::Links-->
            </div>
            <!--end::Footer-->
    ...
    <script src="assets_backend/js/custom/authentication/sign-up/general.js"></script>
