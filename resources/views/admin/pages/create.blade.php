        ...
        <div class="toolbar d-flex flex-stack flex-wrap mb-5 mb-lg-7" id="kt_toolbar">
            ...
            <div class="page-title d-flex flex-column py-1">
                ...
                <h1 class="d-flex align-items-center my-1">
                    <span class="text-dark fw-bolder fs-1">Add a Page</span>
                </h1>
                <!--end::Title-->
            </div>
            <!--end::Page title-->
                        ...
                        <div class="row mb-12">
                            ...
                            <div class="col-lg-12 fv-row">
                                <textarea type="text" name="meta_tags" class="form-control form-control-lg form-control-solid mb-3 mb-lg-0"
                                    placeholder="Meta Tags (Leave empty if you want default meta tags)" rows="5"></textarea>
                            </div>
                            <!--end::Col-->
                            ...
                            <!--begin::Col-->
                            <div class="col-lg-12">
                                <textarea id="editor" placeholder="Page Content *" name="content" autofocus required></textarea>
                            </div>
                            <!--end::Col-->
