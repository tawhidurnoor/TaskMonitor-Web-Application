        ...
        <div class="menu menu-column menu-active-bg menu-hover-bg menu-title-gray-700 fs-6 menu-rounded w-100"
            ...
            <div class="menu-item">
                <a href="{{ route('users.index') }}"
                    class="menu-link {{ request()->segment(1) == 'users' ? 'active' : '' }}">
            ...
            <div class="menu-item">
                <a href="{{ route('faq.index') }}"
                    class="menu-link {{ request()->segment(1) == 'faq' ? 'active' : '' }}">
                    <span class="menu-icon">
                        <!--begin::Svg Icon | path: icons/duotune/general/gen002.svg-->
                        <span class="svg-icon svg-icon-2">
                            <svg xmlns="http://www.w3.org/2000/svg" width="24" height="24"
            ...
            <div class="menu-item">
                <a href="{{ route('metainfo.index') }}"
                    class="menu-link {{ request()->segment(1) == 'metainfo' ? 'active' : '' }}">
                    <span class="menu-icon">
                        <!--begin::Svg Icon | path: icons/duotune/general/gen002.svg-->
                        <span class="svg-icon svg-icon-2">
                            <svg xmlns="http://www.w3.org/2000/svg" width="24" height="24"
            ...
            <div class="menu-item">
                <a href="{{ route('logos.index') }}"
                    class="menu-link {{ request()->segment(1) == 'logos' ? 'active' : '' }}">
                    <span class="menu-icon">
                        <!--begin::Svg Icon | path: icons/duotune/general/gen002.svg-->
                        <span class="svg-icon svg-icon-2">
                            <svg xmlns="http://www.w3.org/2000/svg" width="24" height="24"
