        ...
        <div class="toolbar d-flex flex-stack flex-wrap mb-5 mb-lg-7" id="kt_toolbar">
            <div class="page-title d-flex flex-column py-1">
                <h1 class="d-flex align-items-center my-1">
                    <span class="text-dark fw-bolder fs-1">Inquries</span>
                </h1>
            </div>
        </div>
                        ...
                        <tbody class="text-gray-600 fw-bold">
                            @foreach ($inquiries as $inquiry)
                                <tr>
                                    ...
                                    <td>
                                        <a href="{{ route('inquiries.compose.mail', $inquiry->id) }}"
                                            class="btn btn-light btn-active-light-primary btn-sm"
                                            data-kt-menu-trigger="click" data-kt-menu-placement="bottom-end">Send eMail
                                        </a>
                                        <a class="btn btn-light btn-active-light-danger btn-sm delete_button"
                                            data-id="{{ $inquiry->id }}">Delete</a>
                                        {{-- <a href="{{route('inquiries.destroy', $inquiry->id)}}" class="btn btn-light btn-active-light-danger btn-sm"
                                            data-kt-menu-trigger="click" data-kt-menu-placement="bottom-end">Remove
                                        </a> --}}
