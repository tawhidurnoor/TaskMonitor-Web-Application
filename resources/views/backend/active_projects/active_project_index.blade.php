        ...
        <div class="toolbar d-flex flex-stack flex-wrap mb-5 mb-lg-7" id="kt_toolbar">
            ...
            <div class="d-flex align-items-center py-1">
                ...
                <a href="#" class="btn btn-flex btn-sm btn-primary fw-bolder border-0 fs-6 h-40px"
                    data-bs-toggle="modal" data-bs-target="#kt_modal_create_project" id="kt_toolbar_primary_button">Create
                    Project</a>
                <!--end::Button-->
            </div>
            <!--end::Actions-->
                                        ...
                                        <tr>
                                            ...
                                            <td>
                                                ...
                                                <div class="d-flex flex-column w-100 me-2">
                                                    ...
                                                    @endforeach
                                                    @if (!$tasksToday)
                                                        <span class="text-muted fw-bold text-muted d-block fs-7">Today
                                                            tracker
                                                            not started!</span>
                                                    @endif
                                                </div>
                                            ...
                                            <td>
                                                ...
                                                @else
                                                    <button
                                                        class="btn btn-light-success btn-sm reassign_project_member_button"
                                ...
                                <div class="row">
                                    <div class="col-9">
                                        <input type="email"
                                            ...
                                            value="" placeholder="Search by email"
