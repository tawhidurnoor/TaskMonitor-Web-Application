                ...
                <form action="{{ route('profile.update') }}" method="POST">
                    ...
                    <div class="row mb-7">
                        ...
                        <div class="col-lg-8 fv-row">
                            <input type="text" name="company" id="company" class="form-control @error('company') is-invalid @enderror" value="{{$user->company_name}}">
                            @error('company')
                                <div class="alert alert-danger mt-1">{{ $message }}</div>
                            @enderror
                        </div>
                    ...
                    <div class="row mb-7">
                        ...
                        <label class="col-lg-4 fw-bold">
                            ...
                            <p class="m-0 p-0">
                                ...
                                <!--end::Svg Icon--> <span class="text-muted">Changed email needs to be verified!</span></p>
                        </label>
                        <!--end::Label-->
                        <!--begin::Col-->
                        <div class="col-lg-8">
