            ...
            @if (auth()->user()->login_mode == 'employer')
                ...
                <div class="menu-item">
                    <a href="{{ route('dashboard') }}"
                        class="menu-link {{ request()->segment(1) == 'dashboard' ? 'active' : '' }}">
                ...
                <div class="menu-item">
                    <a href="{{ route('project.index') }}"
                        class="menu-link {{ request()->segment(1) == 'project' ? 'active' : '' }}">
                        <span class="menu-icon">
                ...
                <div class="menu-item">
                    <a href="{{ route('employee.index') }}"
                        class="menu-link {{ request()->segment(1) == 'employee' ? 'active' : '' }}">
                        <span class="menu-icon">
                            <!--begin::Svg Icon | path: icons/duotune/general/gen002.svg-->
                            <span class="svg-icon svg-icon-2">
                                <svg xmlns="http://www.w3.org/2000/svg" width="24" height="24"
            ...
            @else
                ...
                <div class="menu-item">
                    <a href="{{ route('employee.dashboard') }}"
                        class="menu-link {{ request()->segment(1) == 'employee_dashboard' ? 'active' : '' }}">
                        <span class="menu-icon">
                            <!--begin::Svg Icon | path: icons/duotune/general/gen022.svg-->
                            <span class="svg-icon svg-icon-2">
                                <svg xmlns="http://www.w3.org/2000/svg" width="24" height="24"
                ...
                <div class="menu-item">
                    <a href="{{ route('employee.project') }}"
                        class="menu-link {{ request()->segment(1) == 'employee_project' ? 'active' : '' }}">
                        <span class="menu-icon">
                            <!--begin::Svg Icon | path: icons/duotune/general/gen002.svg-->
                            <span class="svg-icon svg-icon-2">
                                <svg xmlns="http://www.w3.org/2000/svg" width="24" height="24"
                ...
                <div class="menu-item">
                    <a href="{{ route('employee.view.invitations') }}"
                        class="menu-link {{ request()->segment(1) == 'invitations' ? 'active' : '' }}">
                        <span class="menu-icon">
                            <!--begin::Svg Icon | path: icons/duotune/general/gen002.svg-->
                            <span class="svg-icon svg-icon-2">
                                <svg xmlns="http://www.w3.org/2000/svg" width="24" height="24"
