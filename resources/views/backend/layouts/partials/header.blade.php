    ...
    <div class="container">
        <div class="row">
            <div class="col-lg-4 col-md-4 col-sm-12 col-xs-12">
                <div class="logo-area">
                    <a href="#">
                        <img src="{{asset('assets_backend/img/logo/logo.png')}}" alt="logo" />
                    </a>
                </div>
            </div>
                            ...
                            <div role="menu" class="dropdown-menu message-dd animated zoomIn">
                                ...
                                <div class="hd-message-info">
                                    <a href="#">
                                        <div class="hd-message-sn">
                                            <div class="hd-message-img">
                                                <img src="{{asset('assets_backend/img/post/1.jpg')}}" alt="" />
                                            </div>
                                            <div class="hd-mg-ctn">
                                                <h3>David Belle</h3>
                                    ...
                                    <a href="#">
                                        <div class="hd-message-sn">
                                            <div class="hd-message-img">
                                                <img src="{{asset('assets_backend/img/post/2.jpg')}}" alt="" />
                                            </div>
                                            <div class="hd-mg-ctn">
                                    ...
                                    <a href="#">
                                        <div class="hd-message-sn">
                                            <div class="hd-message-img">
                                                <img src="{{asset('assets_backend/img/post/4.jpg')}}" alt="" />
                                            </div>
                                            <div class="hd-mg-ctn">
