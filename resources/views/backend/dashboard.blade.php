                ...
                <div class="card card-flush h-md-50 mb-5 mb-xl-10">
                    ...
                    <div class="card-header pt-5">
                        ...
                        <div class="card-title d-flex flex-column">
                            ...
                            <!--end::Info-->
                            <!--begin::Subtitle-->
                            <span class="text-gray-400 pt-1 fw-bold fs-6">Projects Earnings in
                                April</span>
                            <!--end::Subtitle-->
                        </div>
                        <!--end::Title-->
                ...
                <div class="card h-md-100">
                    ...
                    <div class="card-header border-0 pt-5">
                        <h3 class="card-title align-items-start flex-column">
                            ...
                            <span class="text-muted mt-1 fw-bold fs-7">Total 424,567
                                deliveries</span>
                        </h3>
                        <!--begin::Toolbar-->
                            ...
                            <div class="tab-pane fade" id="kt_timeline_widget_3_tab_content_1">
                                ...
                                <div class="d-flex align-items-center mb-6">
                                    ...
                                    <div class="flex-grow-1 me-5">
                                        ...
                                        <!--end::Time-->
                                        <!--begin::Description-->
                                        <div class="text-gray-700 fw-bold fs-6">9 Degree Project
                                            Estimation Meeting</div>
                                        <!--end::Description-->
                                        <!--begin::Link-->
                                ...
                                <div class="d-flex align-items-center mb-6">
                                    ...
                                    <div class="flex-grow-1 me-5">
                                        ...
                                        <!--end::Time-->
                                        <!--begin::Description-->
                                        <div class="text-gray-700 fw-bold fs-6">Dashboard UI/UX
                                            Design Review</div>
                                        <!--end::Description-->
                                        <!--begin::Link-->
                                        <div class="text-gray-400 fw-bold fs-7">Lead by
                                            <!--begin::Name-->
                                            <a href="#" class="text-primary opacity-75-hover fw-bold">Lead
                                                by Bob</a>
                                            <!--end::Name-->
                                        </div>
                                        <!--end::Link-->
                                ...
                                <div class="d-flex align-items-center mb-6">
                                    ...
                                    <div class="flex-grow-1 me-5">
                                        ...
                                        <!--end::Time-->
                                        <!--begin::Description-->
                                        <div class="text-gray-700 fw-bold fs-6">Marketing Campaign
                                            Discussion</div>
                                        <!--end::Description-->
                                        <!--begin::Link-->
                                        <div class="text-gray-400 fw-bold fs-7">Lead by
                            ...
                            <div class="tab-pane fade" id="kt_timeline_widget_3_tab_content_5">
                                ...
                                <div class="d-flex align-items-center mb-6">
                                    ...
                                    <div class="flex-grow-1 me-5">
                                        ...
                                        <!--end::Time-->
                                        <!--begin::Description-->
                                        <div class="text-gray-700 fw-bold fs-6">9 Dashboard UI/UX
                                            Design Review</div>
                                        <!--end::Description-->
                                        <!--begin::Link-->
                                        <div class="text-gray-400 fw-bold fs-7">Lead by
                            ...
                            <div id="kt_schedule_day_0" class="tab-pane fade show">
                                ...
                                <div class="d-flex flex-stack position-relative mt-8">
                                    ...
                                    <div class="fw-bold ms-5 text-gray-600">
                                        ...
                                        <!--end::Time-->
                                        <!--begin::Title-->
                                        <a href="#" class="fs-5 fw-bolder text-gray-800 text-hover-primary mb-2">Team
                                ...
                                <div class="d-flex flex-stack position-relative mt-8">
                                    ...
                                    <div class="fw-bold ms-5 text-gray-600">
                                        ...
                                        <!--end::Time-->
                                        <!--begin::Title-->
                                        <a href="#" class="fs-5 fw-bolder text-gray-800 text-hover-primary mb-2">Lunch
                                            &amp; Learn Catch Up</a>
                                        <!--end::Title-->
                                        <!--begin::User-->
                                        <div class="text-gray-400">Lead by
                            ...
                            <div id="kt_schedule_day_2" class="tab-pane fade show">
                                ...
                                <div class="d-flex flex-stack position-relative mt-8">
                                    ...
                                    <div class="fw-bold ms-5 text-gray-600">
                                        ...
                                        <!--end::Time-->
                                        <!--begin::Title-->
                                        <a href="#" class="fs-5 fw-bolder text-gray-800 text-hover-primary mb-2">Project
                                            Review &amp; Testing</a>
                                        <!--end::Title-->
                                        <!--begin::User-->
                                        <div class="text-gray-400">Lead by
                            ...
                            <div id="kt_schedule_day_5" class="tab-pane fade show">
                                ...
                                <div class="d-flex flex-stack position-relative mt-8">
                                    ...
                                    <div class="fw-bold ms-5 text-gray-600">
                                        ...
                                        <!--end::Time-->
                                        <!--begin::Title-->
                                        <a href="#" class="fs-5 fw-bolder text-gray-800 text-hover-primary mb-2">Weekly
                                            Team Stand-Up</a>
                                        <!--end::Title-->
                                        <!--begin::User-->
                                        <div class="text-gray-400">Lead by
                            ...
                            <div id="kt_schedule_day_10" class="tab-pane fade show">
                                ...
                                <div class="d-flex flex-stack position-relative mt-8">
                                    ...
                                    <div class="fw-bold ms-5 text-gray-600">
                                        ...
                                        <!--end::Time-->
                                        <!--begin::Title-->
                                        <a href="#" class="fs-5 fw-bolder text-gray-800 text-hover-primary mb-2">Sales
                                            Pitch Proposal</a>
                                        <!--end::Title-->
                                        <!--begin::User-->
                                        <div class="text-gray-400">Lead by
                        ...
                        <div class="row gx-9 h-100">
                            ...
                            <div class="col-sm-6 mb-10 mb-sm-0">
                                ...
                                <div class="bgi-no-repeat bgi-position-center bgi-size-cover card-rounded min-h-400px min-h-sm-100 h-100"
                                    style="background-size: 100% 100%;background-image:url('assets_backend/media/stock/600x600/img-33.jpg');">
                                </div>
                                <!--end::Image-->
                            </div>
                            <!--end::Col-->
                            ...
                            <div class="col-sm-6">
                                ...
                                <div class="d-flex flex-column h-100">
                                    ...
                                    <div class="mb-7">
                                        ...
                                        <div class="d-flex flex-stack mb-6">
                                            ...
                                            <div class="flex-shrink-0 me-5">
                                                ...
                                                <span class="text-gray-800 fs-1 fw-bolder">9
                                                    Degree</span>
                                            </div>
                                            <!--end::Title-->
                                            <span
                                        ...
                                        <div class="d-flex align-items-center flex-wrap d-grid gap-2">
                                            ...
                                            <div class="d-flex align-items-center me-5 me-xl-13">
                                                ...
                                                <div class="symbol symbol-30px symbol-circle me-3">
                                                    <img src="assets_backend/media/avatars/300-3.jpg" class="" alt="" />
                                                </div>
                                                <!--end::Symbol-->
                                                <!--begin::Info-->
                                                <div class="m-0">
                                                    <span class="fw-bold text-gray-400 d-block fs-8">Manager</span>
                                                    <span class="fw-bolder text-gray-800 fs-7">Robert
                                                        Fox</span>
                                                </div>
                                                <!--end::Info-->
                                            </div>
                                    ...
                                    <div class="mb-6">
                                        <!--begin::Text-->
                                        <span class="fw-bold text-gray-600 fs-6 mb-8 d-block">Flat
                                            cartoony illustrations with vivid unblended colors and
                                            asymmetrical beautiful purple hair lady</span>
                                        <!--end::Text-->
                                        <!--begin::Stats-->
                                        <div class="d-flex">
                                            <!--begin::Stat-->
                                            <div
                                                ...
                                                <!--begin::Date-->
                                                <span class="fs-6 text-gray-700 fw-bolder">Feb 6,
                                                    2021</span>
                                                <!--end::Date-->
                                                <!--begin::Label-->
                                    ...
                                    <div class="d-flex flex-stack mt-auto bd-highlight">
                                        ...
                                        <div class="symbol-group symbol-hover flex-nowrap">
                                            ...
                                            <div class="symbol symbol-35px symbol-circle" data-bs-toggle="tooltip"
                                                title="Michael Eberon">
                                                <img alt="Pic" src="assets_backend/media/avatars/300-3.jpg" />
                                            </div>
                                            <div class="symbol symbol-35px symbol-circle" data-bs-toggle="tooltip"
                                                title="Susan Redwood">
                                                <span
                        ...
                        <div class="row align-items-center h-100">
                            ...
                            <div class="col-7 ps-xl-13">
                                ...
                                <div class="text-white mb-6 pt-6">
                                    <span class="fs-4 fw-bold me-2 d-block lh-1 pb-2 opacity-75">Get
                                        best offer</span>
                                    <span class="fs-2qx fw-bolder">Upgrade Your Plan</span>
                                </div>
                                <!--end::Title-->
                                <!--begin::Text-->
                                <span class="fw-bold text-white fs-6 mb-8 d-block opacity-75">Flat
                                ...
                                <div class="d-flex flex-column flex-sm-row d-grid gap-2">
                                    <a href="#" class="btn btn-success flex-shrink-0 me-2" data-bs-toggle="modal"
                            ...
                            <div class="col-5 pt-10">
                                ...
                                <div class="bgi-no-repeat bgi-size-contain bgi-position-x-end h-225px"
                                    style="background-image:url('assets_backend/media/svg/illustrations/easy/5.svg');">
                                </div>
                                <!--end::Illustration-->
                            </div>
                            <!--end::Col-->
                ...
                <div class="card card-flush h-md-100">
                    ...
                    <div class="card-header pt-7">
                        ...
                        <h3 class="card-title align-items-start flex-column">
                            ...
                            <span class="text-gray-400 mt-1 fw-bold fs-6">Updated 37 minutes
                                ago</span>
                        </h3>
                        <!--end::Title-->
                        <!--begin::Toolbar-->
                                ...
                                <tbody>
                                        ...
                                        <td>
                                            <div class="d-flex align-items-center">
                                                <div class="symbol symbol-50px me-3">
                                                    <img src="assets_backend/media/stock/600x600/img-49.jpg" class=""
                                                        alt="" />
                                                </div>
                                    ...
                                    <tr>
                                        <td>
                                            <div class="d-flex align-items-center">
                                                <div class="symbol symbol-50px me-3">
                                                    <img src="assets_backend/media/stock/600x600/img-40.jpg" class=""
                                                        alt="" />
                                                </div>
                                                <div class="d-flex justify-content-start flex-column">
                                                    <a href="#"
                                    ...
                                    <tr>
                                        <td>
                                            <div class="d-flex align-items-center">
                                                <div class="symbol symbol-50px me-3">
                                                    <img src="assets_backend/media/stock/600x600/img-39.jpg" class=""
                                                        alt="" />
                                                </div>
                                                <div class="d-flex justify-content-start flex-column">
                                                    <a href="#"
                                    ...
                                    <tr>
                                        <td>
                                            <div class="d-flex align-items-center">
                                                <div class="symbol symbol-50px me-3">
                                                    <img src="assets_backend/media/stock/600x600/img-47.jpg" class=""
                                                        alt="" />
                                                </div>
                                                <div class="d-flex justify-content-start flex-column">
                                                    <a href="#"
                                    ...
                                    <tr>
                                        <td>
                                            <div class="d-flex align-items-center">
                                                <div class="symbol symbol-50px me-3">
                                                    <img src="assets_backend/media/stock/600x600/img-48.jpg" class=""
                                                        alt="" />
                                                </div>
                                                <div class="d-flex justify-content-start flex-column">
                                                    <a href="#"
                    ...
                    <div class="card-body d-flex flex-column flex-center">
                        ...
                        <div class="mb-2">
                            ...
                            <div class="flex-grow-1 bgi-no-repeat bgi-size-contain bgi-position-x-center card-rounded-bottom h-200px mh-200px my-5 my-lg-12"
                                style="background-image:url('assets_backend/media/svg/illustrations/easy/2.svg')">
                            </div>
                            <!--end::Illustration-->
                        </div>
                        <!--end::Heading-->
                            ...
                            <div class="tab-pane active" id="kt_timeline_widget_4_tab_day" role="tabpanel"
                                ...
                                <div class="table-responsive pb-10">
                                    ...
                                    <div id="kt_timeline_widget_4_1" class="vis-timeline-custom h-350px min-w-700px"
                                        data-kt-timeline-widget-4-image-root="/metronic8/demo5/assets/media/">
                                    </div>
                                    <!--end::Timeline-->
                                </div>
                            </div>
