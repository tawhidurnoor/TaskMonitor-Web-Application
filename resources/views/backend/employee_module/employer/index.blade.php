        ...
        <div class="toolbar d-flex flex-stack flex-wrap mb-5 mb-lg-7" id="kt_toolbar">
            ...
            <div class="page-title d-flex flex-column py-1">
                ...
                <h1 class="d-flex align-items-center my-1">
                    <span class="text-dark fw-bolder fs-1">Employer List</span>
                </h1>
                <!--end::Title-->
                <!--begin::Breadcrumb-->
                    ...
                    <div class="card-title">
                        ...
                        <div class="d-flex align-items-center position-relative my-1">
                            ...
                            <input type="text" data-kt-user-table-filter="search"
                                class="form-control form-control-solid w-950px ps-14" placeholder="Search Employer" />
                        </div>
                        <!--end::Search-->
                    </div>
                    <!--begin::Card title-->
                                        ...
                                        <div class="symbol symbol-circle symbol-50px overflow-hidden me-3">
                                            <a href="#">
                                                <div class="symbol-label">
                                                    @isset($employer->profile_picture)
                                                        <img alt="Profile Picture"
                                                            src="{{ asset('uploaded_files/profile_pictures/' . $employer->profile_picture) }}"
                                                            class="w-100" />
                                                    @else
                                                        <img alt="Profile Picture"
