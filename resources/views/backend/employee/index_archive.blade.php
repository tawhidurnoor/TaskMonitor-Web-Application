    ...
    <div class="content flex-column-fluid" id="kt_content">
        ...
        <div class="toolbar d-flex flex-stack flex-wrap mb-5 mb-lg-7" id="kt_toolbar">
            ...
            <div class="d-flex align-items-center py-1">
                <!--begin::Button-->
                <a href="{{ route('employee.index') }}" class="btn btn-sm btn-bg-light btn-active-color-primary me-3">View
                    Active Employees</a>
                                ...
                                <div class="form-check form-check-sm form-check-custom form-check-solid">
                                    ...
                                    <td class="text-end">
                                        ...
                                        <div class="menu menu-sub menu-sub-dropdown menu-column menu-rounded menu-gray-600 menu-state-bg-light-primary fw-bold fs-7 w-125px py-4"
                                            ...
                                            <div class="menu-item px-3">
                                                @isset($employee->mac_address)
                                                    <a href="{{ route('employee.timetracker.noui', $employee->id) }}"
                                                        class="menu-link px-3">Time Tracker</a>
                                                @else
                                            ...
                                            <!--begin::Menu item-->
                                            <div class="menu-item px-3">
                                                <a class="menu-link px-3 unarchive_button"
                                                    data-id="{{ $employee->id }}">Unarchive</a>
                                            </div>
                                            <!--end::Menu item-->
                                        </div>
                                        <!--end::Menu-->
