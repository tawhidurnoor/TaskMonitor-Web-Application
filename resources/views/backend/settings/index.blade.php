                    ...
                    <form id="kt_account_profile_details_form" class="form">
                        ...
                        <div class="card-body border-top p-9">
                            ...
                            <div class="row mb-6">
                                ...
                                <div class="col-lg-8 fv-row">
                                    <select name="screenshot_duration" id="screenshot_duration"
                                        value="{{ $settings->screenshot_duration }}" aria-label="Take dextop screenshots"
                            ...
                            <div class="row mb-6">
                                ...
                                <div class="col-lg-8 fv-row">
                                    <input type="text" name="company_name"
                                        ...
                                        placeholder="Workspace or Company Name" value="{{ auth()->user()->company_name }}"
                                        required />
                                </div>
                                <!--end::Col-->
                            </div>
                            ...
                            <div class="row mb-6">
                                ...
                                <!--begin::Col-->
                                <div class="col-lg-8 fv-row">
                                    <input type="number" name="keep_screenshots"
                                        class="form-control form-control-lg form-control-solid"
                                        placeholder="Screenshot keeping time" value="{{ $settings->keep_screenshots }}"
