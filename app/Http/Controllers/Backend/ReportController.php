...
class ReportController extends Controller
{
    ...
    public function employeeWiseReportPDF(Request $request)
    {
        $date = null;
        $employee_id = null;
        $date_formatted = null;
        ...
        if (!isset($request->date) || !isset($request->employee_id)) {
            return redirect()->route('report.employee');
        }
        ...
        return PDF::loadView('backend.report.pdf.employee', [
            'is_request' => $is_request,
            'date' => $date,
            'employee_id' => $employee_id,
            'employee' => $employee,
        ...
        ], [], $config)->download('order-' . $employee_id . $date . '.pdf');

        // return view('backend.report.pdf.employee', [
        //     'is_request' => $is_request,
        //     'date' => $date,
        //     'employee_id' => $employee_id,
        //     'employee' => $employee,
